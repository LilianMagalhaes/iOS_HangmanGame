...
class WordModeViewController: UIViewController {
    ...
    @IBOutlet weak var wordLabelTest: UILabel!  //TODO: Label to test if we got the film title, hide it after finished testing the game.
    ...
    func getNewWord() {
        ...
        WordManager.shared.fetchRandomWord (maxRetries: 99) { result in
            switch result {
    ...
    private func getValidNumberOfCharacters() -> Int {
        let originalString = self.wordString
